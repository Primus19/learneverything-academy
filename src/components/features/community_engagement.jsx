...
export default function CommunityEngagement({ courseId, courseName }) {
  ...
  const studyGroups = [
    ...
    },
    {
      ...
      members,
      nextMeeting: 'Saturday, 10 AM EST',
    ...
    <Card className="w-full bg-gray-800 border-gray-700 text-white">
        ...
        <Tabs defaultValue="discussions" onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-3 mb-4 bg-gray-900">
            <TabsTrigger value="discussions" className="data-[state=active]-blue-900">
              <MessageSquare className="h-4 w-4 mr-2" />
              Discussions
            </TabsTrigger>
            <TabsTrigger value="study-groups" className="data-[state=active]-purple-900">
              <Users className="h-4 w-4 mr-2" />
              Study Groups
            </TabsTrigger>
            <TabsTrigger value="qa" className="data-[state=active]-green-900">
                ...
                {discussions.map(discussion => (
                  <div key={discussion.id} className="p-4 rounded-lg bg-gray-900 border border-gray-700">
                    <div className="flex items-start gap-3">
                        ...
                        {discussion.author.charAt(0)}</AvatarFallback>
                      </Avatar>
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-3">
                          <button className="flex items-center gap-1 text-sm text-gray-400 hover-blue-400">
                          ...
                          <button className="flex items-center gap-1 text-sm text-gray-400 hover-red-400">
                  ...
                  <div key={question.id} className="rounded-lg overflow-hidden">
                    <div className="p-4 bg-gray-900 border border-gray-700">
                      <div className="flex items-start gap-3">
                          ...
                          {question.author.charAt(0)}</AvatarFallback>
                        </Avatar>
                        <div className="flex-1">
                          <div className="flex justify-between">
                    ...
                    {question.answers.length > 0 && (
                      <div className="pl-8 pr-4 py-3 bg-gray-850 border-x border-b border-gray-700">
                          ...
                          {question.answers.map(answer => (
                            <div key={answer.id} className="flex items-start gap-3">
                              <Avatar className="h-8 w-8">
                                ...
                                {answer.author.charAt(0)}</AvatarFallback>
                              </Avatar>
                              <div className="flex-1">
                        ...
                        <div className="mt-4">
                          ...
                          />
                          <div className="flex justify-end mt-2">
                            <Button size="sm" className="bg-green-600 hover-green-700">
                              Submit Answer
                            </Button>
                          </div>
                        </div>
