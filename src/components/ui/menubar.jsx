...
import * from "react"
import * from "@radix-ui/react-menubar.jsx"
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-none focus-accent focus-accent-foreground data-[state=open]-accent data-[state=open]-accent-foreground",
      className
    )}
    {...props}
  />
