            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-8">
                  <button
                    type="submit"
                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover-blue-700 focus-none focus-2 focus-offset-2 focus-blue-500"
                  >
                ...
                <p className="text-center text-sm text-gray-400 mt-4">
                  ...
                  <Link href="/terms" className="text-blue-400 hover-blue-300">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-blue-400 hover-blue-300">
                    Privacy Policy
                  </Link>
                </p>
              </form>
