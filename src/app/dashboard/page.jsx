...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm-6 lg-8">
        <h1 className="text-3xl font-bold text-white mb-8">Dashboard</h1>
        
        <div className="grid grid-cols-1 lg-cols-4 gap-8">
          {/* Sidebar */}
          <div className="lg-span-1">
            <div className="bg-gray-800 rounded-lg p-6 mb-6">
              ...
              <nav className="space-y-2">
                ...
                <Link href="/dashboard/courses" className="flex items-center px-4 py-2 text-gray-300 hover-gray-700 hover-white rounded-md">
                  <Book className="h-5 w-5 mr-3" />
                  My Courses
                </Link>
                <Link href="/dashboard/certificates" className="flex items-center px-4 py-2 text-gray-300 hover-gray-700 hover-white rounded-md">
                  <FileText className="h-5 w-5 mr-3" />
                  Certificates
                </Link>
                <Link href="/dashboard/billing" className="flex items-center px-4 py-2 text-gray-300 hover-gray-700 hover-white rounded-md">
                  <CreditCard className="h-5 w-5 mr-3" />
                  Billing
                </Link>
                <Link href="/dashboard/settings" className="flex items-center px-4 py-2 text-gray-300 hover-gray-700 hover-white rounded-md">
                  <Settings className="h-5 w-5 mr-3" />
                  Settings
                </Link>
                <Link href="/logout" className="flex items-center px-4 py-2 text-gray-300 hover-gray-700 hover-white rounded-md">
          ...
          <div className="lg-span-3">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-6 mb-8">
              ...
              {user.courses.length > 0 ? (
                <Link href={`/dashboard/courses/${user.courses[0].id}`} className="inline-block px-4 py-2 bg-white text-blue-700 rounded-md font-medium hover-blue-50">
                  Continue Learning
                </Link>
              ) : (
                <Link href="/courses" className="inline-block px-4 py-2 bg-white text-blue-700 rounded-md font-medium hover-blue-50">
                  Browse Courses
                </Link>
              )}
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 mb-8">
              <div className="flex justify-between items-center mb-6">
                ...
                <Link href="/dashboard/courses" className="text-blue-400 hover-blue-300">
                  View All
                </Link>
              </div>
              ...
              {user.courses.length > 0 ? (
                <div className="space-y-4">
                  {user.courses.map((course) => (
                    <div key={course.id} className="bg-gray-700 rounded-lg p-4">
                      ...
                      <Link href={`/dashboard/courses/${course.id}`} className="text-blue-400 hover-blue-300 font-medium">
                        Continue Course
                      </Link>
                    </div>
                  ))}
                ...
                <div className="text-center py-8">
                  ...
                  <Link href="/courses" className="inline-block px-4 py-2 bg-blue-600 text-white rounded-md font-medium hover-blue-700">
                    Browse Courses
                  </Link>
                </div>
              )}
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md-cols-2 gap-4">
                <div className="bg-gray-700 rounded-lg p-4">
                  ...
                  <Link href="/courses/cloud-engineering" className="text-blue-400 hover-blue-300 font-medium">
                    View Course
                  </Link>
                </div>
