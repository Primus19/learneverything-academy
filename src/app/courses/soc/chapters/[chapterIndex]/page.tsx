...
export default function ChapterPage() {
  ...
  const handlePrevChapter = () => {
    if (chapter?.prevChapter !== null) {
      router.push(`/courses/soc/chapters/${chapter.prevChapter}`)
    }
  }

  const handleNextChapter = () => {
    if (chapter?.nextChapter !== null) {
      router.push(`/courses/soc/chapters/${chapter.nextChapter}`)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 text-white">
          ...
          <button 
            onClick={() => router.push('/courses/soc')}
            ...
            <div className="bg-gray-800 rounded-lg p-4 sticky top-8">
              ...
              <div className="space-y-1">
                {course.chapters.map((courseChapter: any, index: number) => (
                  <a
                    key={index}
                    href={`/courses/soc/chapters/${index}`}
