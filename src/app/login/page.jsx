    ...
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm-6 lg-8">
      <div className="sm-auto sm-full sm-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-400">
          Or{' '}
          <Link href="/register" className="font-medium text-blue-500 hover-blue-400">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {errors.general && (
              <div className="bg-red-900/50 border border-red-500 text-red-300 px-4 py-3 rounded relative" role="alert">
                <span className="block sm">{errors.general}</span>
              </div>
            )}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-blue-500 hover-blue-400">
