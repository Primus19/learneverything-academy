...
export default function CourseLayout({
  ...
  const courseData = {
    ...
    description: getCourseDescription(params.courseId),
    chapters: getChapterCount(params.courseId),
  };
  ...
  return (
    <div className="container mx-auto py-8 px-4 md:px-6">
      ...
      <div className="mt-8">
        <Card>
          <CardHeader>
            <CardTitle>Ready to advance your skills?</CardTitle>
            <CardDescription>
...
function getChapterCount(courseId: string): number {
  // All courses have 6 chapters
  return 6;
}

function getRelatedCourses(courseId: string): Array<{ id: string; title: string; description: string }> {
  // Define related courses for each course
  const relatedCourses: Record<string, Array<{ id: string; title: string; description: string }>> = {
    'devops': [
